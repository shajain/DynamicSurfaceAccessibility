...
class BindingInterfaceExtractor:
    def __init__(self, structure: gemmi.Structure, block: gemmi.Block, cutoff: float = 8.0, assembly_index: int = 0):
    ...
    def process_pairwise_contacts(self) -> dict[str, dict[str, dict[str, list[gemmi.Residue]]]]:
        ...
        for r in self.pairwise_contacts:
            ...
            if not (self.is_representative(res1, atom1) and self.is_representative(res2, atom2)):
                continue
